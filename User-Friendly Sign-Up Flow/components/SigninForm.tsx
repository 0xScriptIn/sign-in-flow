...
export function SigninForm({ onSwitchToSignUp }: SigninFormProps) {
  ...
  const handleSubmit = () => {
    if (!validate()) return;
    // Handle sign-in submission (e.g., call API)
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <Button variant="outline" onClick={() => handleSocialSignin('Apple')} className="w-full">
              {/* Apple icon */}
        ...
        <p className="text-xs text-muted-foreground text-center">
          ...
          <button type="button" onClick={onSwitchToSignUp} className="underline hover:text-primary">
            Sign up
          </button>
        </p>
      </CardContent>
